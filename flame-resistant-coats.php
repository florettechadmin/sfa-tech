...
<div class="wrapper prodPad prod-bck">
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 padd wid100">
    	<div class="top_det">
	    	<h2>WIELDER ANTI-STATIC SHORT COAT, NO POCKET</h2>
	    	<ul>
...
<div class="wrapper prodPad1 prod-bck">
  <div class="container">
    ...
    <p>Suitable for Electronic Industries & Clean room environments where ESD Protection is required.<br>Concealed Front Snap Buttons which provide extra safety to the process.<br>Sleeve cuff with full Elastic which gives extra closing.<br> No Pockets for Extra safety.<br>Length up to Mid-Thigh.</p>
  </div>
</div>
