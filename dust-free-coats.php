...
<div class="wrapper prodPad prod-bck">
    ...
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 brder padL padR wid100">
    	<img src="images/products/dust-free-coats.jpg" alt="dust-free-coats" />
    </div>
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 padd mb50 wid100">
    	<div class="top_det">
	    	<h2>LINT FREE SHORT COAT </h2>
	    	<ul>
	    		<li>Product Number : <span>40000</span></li>
	    	</ul>
	    	<ul>
...
<div class="wrapper prodPad1 prod-bck">
  <div class="container">
    ...
    <p>Suitable for environment where the workwear has to be lint free.<br>Concealed Front Snap Buttons which provide extra safety to the process.<br>Sleeve cuff with full Elastic which gives extra closing.<br>No Pockets for Extra safety.<br> Length up to Mid-Thigh. 
</p>
  </div>
</div>
